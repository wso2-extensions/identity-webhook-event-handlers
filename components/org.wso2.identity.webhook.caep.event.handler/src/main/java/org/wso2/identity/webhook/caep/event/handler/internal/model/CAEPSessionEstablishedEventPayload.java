...
/**
 * This class represents the payload for session established events in CAEP.
 */

public class CAEPSessionEstablishedEventPayload extends CAEPBaseEventPayload {

    private CAEPSessionEstablishedEventPayload(Builder builder) {
    ...
    public static class Builder {
        ...
        public CAEPSessionEstablishedEventPayload build() {

            return new CAEPSessionEstablishedEventPayload(this);
        }
    }
}
