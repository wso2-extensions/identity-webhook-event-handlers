...
public class UserOperationEventHookHandlerTest {
    ...
    public Object[][] eventDataProvider() {
        ...
        return new Object[][]{
                {IdentityEventConstants.Event.POST_UPDATE_USER_LIST_OF_ROLE,
                        Constants.EventHandlerKey.POST_UPDATE_USER_LIST_OF_ROLE_EVENT, SAMPLE_EVENT_KEY}
        };
    }
    ...
    public void testHandleEventWithPublishingDisabled() throws
        ...
        Resources resources =
                createResourcesWithAttributes(Constants.EventHandlerKey.POST_UPDATE_USER_LIST_OF_ROLE_EVENT);
    ...
    private void setupUtilities() {
        ...
        userOperationEventHookHandler = new UserOperationEventHookHandler(mockedEventHookHandlerUtils,
